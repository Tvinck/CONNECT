  ...
  return (
    <PageContainer>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-5 mb-5">
        {/* Tasks list */}
        <div className="xl:col-span-2 rounded-2xl border border-white/[0.06] bg-white/[0.03] p-6 space-y-3">
          <div className="flex items-center justify-between mb-2">
            <Skeleton className="h-5 w-28" />
            <Skeleton className="h-4 w-16" />
          </div>
          {[...Array(4)].map((_, i) => (
            <div key={i} className="flex items-center gap-4 rounded-xl border border-white/[0.04] px-4 py-3.5">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-5">
        ...
        <div className="rounded-2xl border border-white/[0.06] bg-white/[0.03] p-6 space-y-3">
          ...
          {[...Array(4)].map((_, i) => (
            <div key={i} className="flex items-start gap-3 rounded-xl border border-white/[0.04] p-3">
              <Skeleton className="h-8 w-8 rounded-lg shrink-0" />
              <div className="flex-1 space-y-2">
                <Skeleton className="h-3.5 w-3/4" />
