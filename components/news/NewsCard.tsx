...
export function NewsCard({ news }: { news: any }) {
  ...
  return (
    <Link href={`/news/${news.id}`} className="block border border-line bg-card rounded-2xl p-5 hover:border-blue-500/30 hover:shadow-lg transition-all duration-200">
