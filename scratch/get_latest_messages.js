...
conn.on('ready', () => {
  ...
  const cmd = `
    curl -s "https://fhwrdhebhgywhvoeqpxj.supabase.co/rest/v1/support_messages?select=id,message,sender_email,is_from_user,created_at&order=created_at.desc&limit=15" \
