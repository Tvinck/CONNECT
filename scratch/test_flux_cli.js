...
async function test() {
  ...
  console.log('Running Higgsfield CLI for FLUX.2...');
  try {
    const { stdout, stderr } = await execAsync('node ./node_modules/@higgsfield/cli/bin/higgsfield.js generate create flux_2 --prompt "A beautiful cinematic landscape, 9:16 aspect ratio" --aspect_ratio "9:16" --json', {
